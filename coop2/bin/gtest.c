...
"DC":1/0(1byte) -- set config display on/off, if set to 1, displayer will
display current commucation setting when power on Text Function command
"CL": -- Clear screen--OK
...
"DM":"C/!/~/&/|/^"(ASCII 1byte) -- set drawing mode--C="Copy",! and ~ = "Not", 
& = "And", | = "Or", ^ = "Xor"
"SC":1/0 (1byte) -- set draw color--only 1 and 0
"LN":x0(1byte) y0(1byte) x1(1byte) y2(1byte)--draw line from x0,y0 to x1,y1,set
 new pot to x1,y1
...
"DR":x0(1byte) y0(1byte) x1(1byte) y2(1byte)--draw rectangle, top-left:x0,y0;
 right-bottom:x1,y1
"FR":x0(1byte) y0(1byte) x1(1byte) y2(1byte)--draw filled rectangle,
 top-left:x0,y0; right-bottom:x1,y1
*/
